   		...
   		<tr><td>
		    <table width="100%" border="0" cellpadding="8" cellspacing="1" bgcolor="#dddddd">
			    <tr>
					...
					<!-- <td><a href="jsp/Mission/ChangeSjljh.jsp"><input type="button" value="数据零件号状态变更申请" style="height: 25px;width: 160px; background:#C6E2FF;"/></a></td>
					<td><a href="jsp/Mission/ChangeIni.jsp"><input type="button" value="整车信息状态变更申请" style="height: 25px;width: 160px; background:red;"/></a></td>
		...
		<form name="form" action="" method="post" enctype="multipart/form-data">
			<table bgcolor="#E0EEEE" width="100%" font-size="50">
				...
				<tr>
					...
					%>
						<td><input type="text" name="version" id="version" value="" onkeyup="this.value = this.value.toUpperCase();" onchange="yuanzhuangtai()" onclick="versionclick()"/></td>	
					<%
						}
					 %>
