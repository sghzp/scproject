...
<%
    ...
    lidi.addLogInfo(new java.text.SimpleDateFormat("yyyyMMddHHmmss").format(new java.util.Date()), "用户"+(String)session.getAttribute("username")+"下载Hex文件"+ hi.getHEXFile() +"成功");
	...
	if(check ==4){
		path.append(hi.getSBLFileName());
		 ...
		 LogInfoDaoImpl lidi = new LogInfoDaoImpl();
    	lidi.addLogInfo(new java.text.SimpleDateFormat("yyyyMMddHHmmss").format(new java.util.Date()), "用户"+(String)session.getAttribute("username")+"下载SBL文件"+ hi.getSBLFileName() +"成功");
	...
	if(check == 5){
		...
		path.append(hi.getSREFileName());
		 ...
		 LogInfoDaoImpl lidi = new LogInfoDaoImpl();
    	lidi.addLogInfo(new java.text.SimpleDateFormat("yyyyMMddHHmmss").format(new java.util.Date()), "用户"+(String)session.getAttribute("username")+"下载SRE文件"+ hi.getSREFileName() +"成功");
