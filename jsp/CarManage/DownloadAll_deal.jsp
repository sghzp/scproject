...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   //System.out.println("hehe");
    ...
    out = pageContext.pushBody();
		...
		}else if(hexInfos2.size() != 0){//下载临时状态的，而且要用户选择
			%>
				<html>
					<head>
						...
						<script>
							function download(){
								...
								if(version == undefined){
									...
									window.location.href="<%=basePath%>/jsp/CarManage/DownloadAll_deal_for_linshistate.jsp?ecutype="+ecutype+"&sjljh="+ sjljh +"&inifile="+inifile+"&iniid=" + iniid+"&version=" + version+"&sbm=" + sbm+"&ecuorder=" + ecuorder;
								}
