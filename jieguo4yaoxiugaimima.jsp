  ...
  <div style="margin: 0 auto;width:40%;">
   <table style=" font-size: 13px;border: 1px solid #000000;cellspacing: 0px; border-collapse:collapse;cellspacing:0px;height:30%;width:100%;background: #E0EEEE;">
    ...
    <tr>
    	<td></td>
    	<td>
    		<input type="button" id="tijiao" onclick="tijiao()" value="提交" style="border:1; height: 22px; width: 50px; 
					background: #555555; color:#ffffff">
			<input type="button" id="tijiao" onclick="forget()" value="忘记密码？" style="border:1; height: 22px; width: 80px; 
					background: #555555; color:#ffffff">
			<input type="button" id="tijiao" onclick="again()" value="重新登录" style="border:1; height: 22px; width: 80px; 
					background: #555555; color:#ffffff">
    	</td>
    </tr> 
    </table>
